...
if(isset($_SESSION['usuarioLogeado'])){  
    ...
    INNER JOIN productos ON carrito.ID_PRODUCTOS=productos.id_pro","carrito.ID_USUARIOS='".$_SESSION["usuarioLogeado"]."' AND estado_car='0'");
    foreach($busqCarrito as $car){ 
        ...
        <td><h3 class='nombreProBolsaCar'>".$car['nombre_pro']."</h3></td>
         ...
         <td><h3 class='precioBolsaCar'> S/ ".number_format($car['precio_pro'],1)."</h3></td></tr>";
