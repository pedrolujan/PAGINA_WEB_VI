...
<div class="contenFTPAcciones">
    <?php  if(isset($_SESSION["adminLogeado"])){?>
        <a href="#form-DescripcionProducto" rel="modal:open" >
            <img src="http://localhost/L&M.StoreTecnology/imagenes/fuentes/icon_editar.png" alt="" srcset="" class="btnEditFT" id="btnEditDetalle">
        </a>
    <?php }?>
</div>  
							
    <img src="../imagenes/productos/10122022092_72celular.jpg" alt="" srcset="" class="imagen1DescripPro" id="imagen1DescripPro">
    ...
    <img src="http://localhost/L&M.StoreTecnology/imagenes/productos/asus-laptop.jpg" alt="" srcset="" class="imagen2DescripPro" id="imagen2DescripPro">
