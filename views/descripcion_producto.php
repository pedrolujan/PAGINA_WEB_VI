...
<div class="contenFTPAcciones">
    <?php  if(isset($_SESSION["adminLogeado"])){?>
        <a href="#form-DescripcionProducto" rel="modal:open" >
            <img src="imagenes/fuentes/icon_editar.png" alt="" srcset="" class="btnEditFT" id="btnEditDetalle">
        </a>
    <?php }?>
</div>  
							
    <img src="imagenes/productos/asus-logo.jpg" alt="" srcset="" class="imagen1DescripPro" id="imagen1DescripPro">
    ...
    <img src="imagenes/productos/asus-laptop.jpg" alt="" srcset="" class="imagen2DescripPro" id="imagen2DescripPro">
</body>
</html>